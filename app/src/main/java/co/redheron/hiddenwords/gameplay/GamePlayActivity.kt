...
import co.redheron.hiddenwords.SoundPlayer
import co.redheron.hiddenwords.commons.DurationFormatter
import co.redheron.hiddenwords.commons.Util
import co.redheron.hiddenwords.commons.viewBinding
import co.redheron.hiddenwords.custom.LetterBoard.OnLetterSelectionListener
import co.redheron.hiddenwords.custom.StreakView.StreakLine
...
class GamePlayActivity : FullscreenActivity() {
    ...
    companion object {
        const val EXTRA_GAME_ROUND_ID = "co.redheron.hiddenwords.gameplay.GamePlayActivity.ID"
        const val EXTRA_ROW_COUNT = "co.redheron.hiddenwords.gameplay.GamePlayActivity.ROW"
        const val EXTRA_COL_COUNT = "co.redheron.hiddenwords.gameplay.GamePlayActivity.COL"
        const val EXTRA_GAME_DATA =
            "co.redheron.hiddenwords.gameplay.GamePlayActivity.GAME_DATA"
